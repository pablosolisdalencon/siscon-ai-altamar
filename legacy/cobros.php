	...
	case(""):
		...
		while($c=mysql_fetch_array($query_c))
		{
			...
			if(mysql_num_rows($query_v)!="0"){
				...
				$TABLA_COBRO='
				<table>
				<tr><th colspan="8" style="background-color:#333;font-size:24px;padding:10px;">'.$c["razon"].'</th><th id="send_cobro"> <i class="fas fa-envelope" onclick="view_mail_cobro(\''.$c['id_cliente'].'\');"></i></th></tr>
					<tr>
